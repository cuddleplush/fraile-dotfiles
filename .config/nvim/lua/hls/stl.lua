...
return {
  ...
  StalineFilename = { bg = colors.color0, fg = colors.color7 },
  ...
  StalineBranch = { bg = colors.color0, fg = colors.comment },
  ...
  StalineEmptySpace = { bg = colors.color0, fg = colors.color15 },
  ...
  StalineDiffAdd = { bg = colors.color0, fg = colors.color10 },
  StalineDiffAddFancy = { bg = utils.darken(colors.color2, colors.black, 0.07), fg = colors.color10 },
  StalineDiffChange = { bg = colors.color0, fg = colors.color11 },
  ...
  StalineDiffRemove = { bg = colors.color0, fg = colors.color9 },
  StalineDefaultFile = { bg = colors.color0, fg = colors.foreground },
}
